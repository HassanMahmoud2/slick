...
import com.github.tminglei.slickpg.{ExPostgresProfile, PgArraySupport, PgDate2Support, PgHStoreSupport, PgJsonSupport, PgPlayJsonSupport}
...
trait CustomPostgresProfile
  ...
  object CustomPostgresAPI
    ...
    implicit val stringListTypeMapper: DriverJdbcType[List[String]] = new SimpleArrayJdbcType[String]("text").to(_.toList)
